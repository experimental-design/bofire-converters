...
def convert_outputs_and_objectives(outputs:Parameters, objectives:Objectives):
    ...
    for o in objectives: 
        if isinstance(o, CloseToTarget):
            ...
            obj = CloseToTargetObjective(key=o.name, target_value=o.target, exponent=o.exponent)
...
def domain_from_opti(opti_problem: Problem) -> Domain:
    ...
    domain_outputs =  convert_outputs_and_objectives(opti_problem.outputs, opti_problem.objectives)
